...
<!-- TODO: Add your project screenshots here -->
| Desktop View | Mobile View |
| :--- | :--- |
| ![Desktop Placeholder](https://via.placeholder.com/800x450?text=Desktop+View) | ![Mobile Placeholder](https://via.placeholder.com/200x400?text=Mobile+View) |
...
- **Clean UI:** Professional typography and spacing for a polished look.
...
The project is designed to be hosted on platforms like **GitHub Pages**, **Netlify**, or **Vercel**. To deploy on GitHub Pages:
